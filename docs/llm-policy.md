...
This policy defines acceptable and unacceptable use of LLMs and AI agents for open-source work in this repository and repositories generated by repoforge.
...
Repositories generated by repoforge should keep an LLM policy, update it for their own risk profile, and make clear who can approve agent-authored work.
