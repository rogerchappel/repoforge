...
in repositories generated by repoforge.
...
```md
You are working in [REPOSITORY_NAME], a repository generated by repoforge.
...
- Run `rg '\{\{[A-Z0-9_]+\}\}'` and explain any intentional remaining
  placeholders.
- Run `rg 'template repository|starter|placeholder|TODO'`
